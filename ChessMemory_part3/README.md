Trzecia część z cyklu ChessMemory, w której implementujemy algorytm losowego rozstawiania figur na szachownicy.

# Część III – Generator losowy
Mamy już szachownicę, którą utworzyliśmy w [pierwszej części](https://github.com/jarfos/ChessMemory/tree/main/ChessMemory_part1), „silnik” gry też już działa, co zostało opisane w drugiej części. Pozostało tylko dostarczyć odpowiednich danych temu silnikowi, czyli napisać algorytm, który będzie losował inicjalne ustawienie figur na szachownicy.
